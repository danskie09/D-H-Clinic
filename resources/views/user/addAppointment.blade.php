...
<head>
    ...
    <title>D&H | Add Appointment</title>
    ...
    @csrf
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          ...
          <input type="tel" class="form-control" name="phone"  id="phoneNumber" value="{{ Auth::user()->phone }}">
        </div>
        <div class="col-md-6 mb-3">
          <label for="message" class="form-label">Purpose</label>
          <textarea class="form-control" name="message"  id="message" rows="3" placeholder="Write your message here"></textarea>
        </div>
      </div>
